...
import org.eclipse.ecr.core.event.tx.EventBundleTransactionHandler;
...
public class AsyncEventExecutor {
    ...
    public static AsyncEventExecutor create() {
        ...
        val = Framework.getProperty("org.eclipse.ecr.core.event.async.maxPoolSize");
        int maxPoolSize = val == null ? 16 : Integer.parseInt(val);
        val = Framework.getProperty("org.eclipse.ecr.core.event.async.keepAliveTime");
        int keepAliveTime = val == null ? 0 : Integer.parseInt(val);
        val = Framework.getProperty("org.eclipse.ecr.core.event.async.queueSize");
