...
public final class Framework {
    ...
    private static void initServiceManager() {
        serviceMgr = org.eclipse.ecr.runtime.api.ServiceManager.getInstance();
    }
    ...
    public static boolean isTestModeSet() {
        String test = getProperty("org.eclipse.ecr.runtime.testing");
        if (test == null) {
            test = System.getProperty("org.eclipse.ecr.runtime.testing");
        }
