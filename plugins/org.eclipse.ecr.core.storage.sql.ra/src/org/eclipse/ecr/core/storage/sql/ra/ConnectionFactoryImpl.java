...
import org.eclipse.ecr.core.storage.sql.coremodel.SQLSecurityManager;
import org.eclipse.ecr.core.storage.sql.coremodel.SQLSession;
...
public class ConnectionFactoryImpl implements Repository,
    ...
    @Override
    public org.eclipse.ecr.core.model.Session getSession(
     ...
     */
    @Override
    public synchronized org.eclipse.ecr.core.model.Session[] getOpenedSessions() {
        return new org.eclipse.ecr.core.model.Session[0];
    }
    ...
    /*
     * ----- org.eclipse.ecr.core.model.RepositoryManagement -----
     */
