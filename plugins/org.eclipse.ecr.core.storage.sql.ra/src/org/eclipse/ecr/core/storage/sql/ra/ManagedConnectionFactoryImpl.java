...
public class ManagedConnectionFactoryImpl implements ManagedConnectionFactory,
    ...
    /*
     * ----- org.eclipse.ecr.core.storage.sql.RepositoryManagement -----
     */
    ...
    protected static RepositoryDescriptor getRepositoryDescriptor(String name)
        ...
        org.eclipse.ecr.core.repository.RepositoryDescriptor d = NXCore.getRepositoryService().getRepositoryManager().getDescriptor(
                name);
        try {
            XMap xmap = new XMap();
