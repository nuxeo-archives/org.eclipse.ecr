...
import org.eclipse.ecr.core.storage.sql.testlib.DatabaseDerby;
...
public class TestSQLRepositoryQuery extends SQLRepositoryTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        deployContrib(TEST_BUNDLE, "OSGI-INF/testquery-core-types-contrib.xml");
    ...
    public void testQueryIterableWithTransformer() throws Exception {
        ...
        deployContrib(TEST_BUNDLE, "OSGI-INF/security-policy2-contrib.xml");
